...
public class Player_armysDAO extends JdbcTemplate {
    static Log log = LogFactory.getLog(Player_armysDAO.class);

    public static final String TABLE = "player_armys";
    ...
    public static String[] carrays ={"id", "army_name", "pcid", "player_name", "gid", "lvl", "num", "bcid"};
    public static String coulmns = "id, army_name, pcid, player_name, gid, lvl, num, bcid";
    public static String coulmns2 = "army_name, pcid, player_name, gid, lvl, num, bcid";

    public Player_armysDAO(java.sql.Connection conn) {
        super(conn);
    }

    public Player_armysDAO(javax.sql.DataSource ds) {
        super(ds);
    }

    public Player_armysDAO(javax.sql.DataSource ds_r, javax.sql.DataSource ds_w) {
        super(ds_r, ds_w);
    }

    public int insert(final Player_armys player_armys) {
        return insert(player_armys, TABLENAME);
    }

    public int insert(final Player_armys player_armys, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try {
            player_armys.reset();
            sql.append("INSERT INTO ").append(TABLENAME2).append(" (army_name, pcid, player_name, gid, lvl, num, bcid) VALUES (:army_name, :pcid, :player_name, :gid, :lvl, :num, :bcid)");
            Map map = super.insert(sql.toString(), player_armys);
    ...
    public void asynchronousInsert(final Player_armys player_armys) {
        asynchronousInsert(player_armys, TABLENAME);
    }

    public void asynchronousInsert(final Player_armys player_armys, final String TABLENAME2) {
        try {
            incrementAndGet();
            executor().execute(new Runnable() {
                public void run() {
                   try {
                       insert(player_armys, TABLENAME2);
                   } catch (Exception e) {
                       log.error(e2s(e));
                   } finally {
                       decrementAndGet();
    ...
    public int asynchronousInsert2(final Player_armys player_armys) {
        return asynchronousInsert2(player_armys, TABLENAME);
    }

    public int asynchronousInsert2(final Player_armys player_armys, final String TABLENAME2) {
        try {
            incrementAndGet();
            ...
            executor().execute(new Runnable() {
                public void run() {
                   try {
                       insert2(player_armys, TABLENAME2);
                   } catch (Exception e) {
                       log.error(e2s(e));
                   } finally {
                       decrementAndGet();
        ...
        return player_armys.id;
    }

    public int insert2(final Player_armys player_armys) {
        return insert2(player_armys, TABLENAME);
    }

    public int insert2(final Player_armys player_armys, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            player_armys.ustr();
            sql.append("INSERT INTO ").append(TABLENAME2).append(" (id, army_name, pcid, player_name, gid, lvl, num, bcid) VALUES (:id, :army_name, :pcid, :player_name, :gid, :lvl, :num, :bcid)");
            Map map = super.insert(sql.toString(), player_armys);
            return getInt(map, "GENERATED_KEY");
        } catch(Exception e) {
            log.info(e2s(e));
    ...
    public int[] insert(final List<Player_armys> player_armyss) {
        return insert(player_armyss, TABLENAME);
    }

    public int[] insert(final List<Player_armys> player_armyss, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try {
            if(player_armyss == null || player_armyss.isEmpty()) return new int[0];
            sql.append("INSERT INTO ").append(TABLENAME2).append(" (army_name, pcid, player_name, gid, lvl, num, bcid) VALUES (:army_name, :pcid, :player_name, :gid, :lvl, :num, :bcid)");
            return super.batchInsert(sql.toString(), player_armyss);
         } catch (Exception e) {
             log.info(e2s(e));
             return new int[0];
        } finally {
    ...
    public int deleteInBeans(final List<Player_armys> beans) {
        return deleteInBeans(beans, TABLENAME);
    }

    public int deleteInBeans(final List<Player_armys> beans, final String TABLENAME2) {
        StringBuffer sb = StringBufPool.borrowObject();
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            ...
            int size = beans.size();
            for (int i = 0; i < size; i ++) {
                Player_armys player_armys = beans.get(i);
    ...
    public List<Player_armys> selectAll() {
        return selectAll(TABLENAME);
    }

    public List<Player_armys> selectAll(final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" ORDER BY id");
            return super.queryForList(sql.toString(), Player_armys.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
        } finally {
    ...
    public List<Map> selectInIndex(final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, pcid, gid, bcid FROM ").append(TABLENAME2).append(" ORDER BY id");
    ...
    public List<Player_armys> selectIn(final List<Integer> keys) {
        return selectIn(keys, TABLENAME);
    }

    public List<Player_armys> selectIn(final List<Integer> keys, final String TABLENAME2) {
        StringBuffer sb = StringBufPool.borrowObject();
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            ...
            String str = sb.toString();
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id in (").append(str).append(" ) ORDER BY id");
            return super.queryForList(sql.toString(), Player_armys.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public List<Player_armys> selectIn2(final List<Integer> keys) {
        return selectIn2(keys, TABLENAME);
    }

    public List<Player_armys> selectIn2(final List<Integer> keys, final String TABLENAME2) {
        StringBuffer sb = StringBufPool.borrowObject();
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            if(keys == null || keys.isEmpty()) return newList();
            ...
            String str = sb.toString();
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id in ( :str ) ORDER BY id");
            Map params = newMap();
            params.put("str", str);
            return super.queryForList(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
        } finally {
    ...
    public List<Player_armys> selectLast(final int num) {
        return selectLast(num, TABLENAME);
    }

    public List<Player_armys> selectLast(final int num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" ORDER BY id DESC LIMIT ").append(num).append("");
            return super.queryForList(sql.toString(), Player_armys.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public Player_armys last() {
        return last(TABLENAME);
    }

    public Player_armys last(final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" ORDER BY id DESC LIMIT 1");
            return super.queryForObject(sql.toString(), Player_armys.class);
        } catch(Exception e) {
            // log.info(e2s(e));
            return null;
        } finally {
    ...
    public List<Player_armys> selectGtKeyNum(final int id, final int _num) {
        return selectGtKeyNum(id, _num, TABLENAME);
    }

    public List<Player_armys> selectGtKeyNum(final int id, final int _num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id > :id ORDER BY id LIMIT ").append(_num).append("");
            Map params = newMap();
            params.put("id", id);
            return super.queryForList(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
    ...
    public List<Player_armys> selectGtKey(final int id) {
        return selectGtKey(id, TABLENAME);
    }

    public List<Player_armys> selectGtKey(final int id, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id > :id ORDER BY id");
            Map params = newMap();
            params.put("id", id);
            return super.queryForList(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
    ...
    public Player_armys selectByKey(final int id) {
        return selectByKey(id, TABLENAME);
    }

    public Player_armys selectByKey(final int id, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id = :id");
            Map params = newMap();
            params.put("id", id);
            return super.queryForObject(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
            // log.info(e2s(e));
            return null;
        } finally {
    ...
    public Player_armys selectById(final Integer id) {
        return selectById(id, TABLENAME);
    }

    public Player_armys selectById(final Integer id, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE id = :id");
            Map params = newMap();
    ...
    public Player_armys selectByPcidGidBcid(final Integer pcid, Integer gid, Integer bcid) {
        return selectByPcidGidBcid(pcid, gid, bcid, TABLENAME);
    }

    public Player_armys selectByPcidGidBcid(final Integer pcid, Integer gid, Integer bcid, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE pcid=:pcid AND gid=:gid AND bcid=:bcid");
            Map params = newMap();
    ...
    public List<Player_armys> selectByPcid(final Integer pcid) {
        return selectByPcid(pcid, TABLENAME);
    }

    public List<Player_armys> selectByPcid(final Integer pcid, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE pcid = :pcid ORDER BY id ");
            Map params = newMap();
            params.put("pcid", pcid);
            return super.queryForList(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
    ...
    public List<Player_armys> selectPageByPcid(final Integer pcid, final int begin, final int num) {
        return selectPageByPcid(pcid, begin, num, TABLENAME);
    }

    public List<Player_armys> selectPageByPcid(final Integer pcid, final int begin, final int num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" WHERE pcid = :pcid ORDER BY id LIMIT ").append(begin).append(", ").append(num).append("");
            Map params = newMap();
            params.put("pcid", pcid);
            return super.queryForList(sql.toString(), params, Player_armys.class);
        } catch(Exception e) {
    ...
    public List<Player_armys> selectByPage(final int begin, final int num) {
        return selectByPage(begin, num, TABLENAME);
    }

    public List<Player_armys> selectByPage(final int begin, final int num, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            sql.append("SELECT id, army_name, pcid, player_name, gid, lvl, num, bcid FROM ").append(TABLENAME2).append(" ORDER BY id LIMIT ").append(begin).append(", ").append(num).append("");
            return super.queryForList(sql.toString(), Player_armys.class);
        } catch(Exception e) {
            log.info(e2s(e));
            return newList();
    ...
    public int updateByKey(final Player_armys player_armys) {
        return updateByKey(player_armys, TABLENAME);
    }

    public int updateByKey(final Player_armys player_armys, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            String _ustr = player_armys.ustr();
            if( _ustr.length() <= 0 )
                return -1;
            sql.append("UPDATE ").append(TABLENAME2).append(" SET ").append(_ustr).append(" WHERE id=:id");
            return super.update(sql.toString(), player_armys);
        } catch(Exception e) {
            log.info(e2s(e));
            return 0;
        } finally {
    ...
    public void asynchronousUpdate(final Player_armys player_armys) {
        asynchronousUpdate(player_armys, TABLENAME);
    }

    public void asynchronousUpdate(final Player_armys player_armys, final String TABLENAME2) {
        try {
    ...
    public int[] updateByKey (final List<Player_armys> player_armyss) {
        return updateByKey(player_armyss, TABLENAME);
    }

    public int[] updateByKey (final List<Player_armys> player_armyss, final String TABLENAME2) {
        StringBuffer sql = StringBufPool.borrowObject();
        try{
            if(player_armyss == null || player_armyss.isEmpty()) return new int[0];
            sql.append("UPDATE ").append(TABLENAME2).append(" SET army_name=:army_name, pcid=:pcid, player_name=:player_name, gid=:gid, lvl=:lvl, num=:num, bcid=:bcid WHERE id=:id");
            return super.batchUpdate2(sql.toString(), player_armyss);
        } catch(Exception e) {
            log.info(e2s(e));
            return new int[0];
        } finally {
