...
public class B2OutputStream {
	...
	public static final void writeByte(ChannelBuffer os, int v)
			throws IOException {
		if (v == 0)
	...
	public static final void writeShort(ChannelBuffer os, int v)
			throws IOException {
		if (v == 0)
	...
	public static final int writeInt(ChannelBuffer os, int v)
			throws IOException {
		switch (v) {
		case -1:
	...
	public static final void writeIntArray(ChannelBuffer os, int[] v)
			throws IOException {
		int len = v.length;
		switch (len) {
		case 0:
	...
	public static final void writeInt2DArray(ChannelBuffer os, int[][] v)
			throws IOException {
		int len = v.length;
		if (len <= 0) {
	...
	public static final void writeLong(ChannelBuffer os, long v)
			throws IOException {
		if (v == 0) {
	...
	static final LRUCache<String, byte[]> stringCache = new LRUCache<String, byte[]>(128);
	...
	public static final void writeString(ChannelBuffer os, String v)
		...
		if (v == null) {
			...
			byte[] b = null;
			if (stringCache.containsKey(v)) {
				b = stringCache.get(v);
			} else {
				b = v.getBytes(Charset.forName("UTF-8"));
			}
	...
	public static final void writeBytes(ChannelBuffer os, byte[] v)
			throws IOException {
		if (v == null) {
			writeNull(os);
		} else {
	...
	public static final void writeVector(ChannelBuffer os, List v)
			throws Exception {
		if (v == null) {
			writeNull(os);
		} else {
	...
	// }
	//
	// protected static final void printString(ChannelBuffer os, String v, int
	// offset,
